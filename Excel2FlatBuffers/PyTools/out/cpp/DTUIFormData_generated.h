...
#ifndef FLATBUFFERS_GENERATED_DTUIFORMDATA_GAMECONFIG_H_
#define FLATBUFFERS_GENERATED_DTUIFORMDATA_GAMECONFIG_H_
...
struct DTUIFormDataList;

struct DTUIFormData FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
...
struct DTUIFormDataBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_Id(uint32_t Id) {
    fbb_.AddElement<uint32_t>(DTUIFormData::VT_ID, Id, 0);
  }
  void add_UIName(flatbuffers::Offset<flatbuffers::String> UIName) {
    fbb_.AddOffset(DTUIFormData::VT_UINAME, UIName);
  }
  void add_UIGroupName(flatbuffers::Offset<flatbuffers::String> UIGroupName) {
    fbb_.AddOffset(DTUIFormData::VT_UIGROUPNAME, UIGroupName);
  }
  void add_AllowMultiInstance(uint32_t AllowMultiInstance) {
    fbb_.AddElement<uint32_t>(DTUIFormData::VT_ALLOWMULTIINSTANCE, AllowMultiInstance, 0);
  }
  void add_PauseCoveredUIForm(uint32_t PauseCoveredUIForm) {
    fbb_.AddElement<uint32_t>(DTUIFormData::VT_PAUSECOVEREDUIFORM, PauseCoveredUIForm, 0);
  }
  void add_AssetPath(flatbuffers::Offset<flatbuffers::String> AssetPath) {
    fbb_.AddOffset(DTUIFormData::VT_ASSETPATH, AssetPath);
  }
  void add_LuaFile(flatbuffers::Offset<flatbuffers::String> LuaFile) {
    fbb_.AddOffset(DTUIFormData::VT_LUAFILE, LuaFile);
  }
  explicit DTUIFormDataBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  DTUIFormDataBuilder &operator=(const DTUIFormDataBuilder &);
  flatbuffers::Offset<DTUIFormData> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<DTUIFormData>(end);
    return o;
  }
};

inline flatbuffers::Offset<DTUIFormData> CreateDTUIFormData(
  ...
  DTUIFormDataBuilder builder_(_fbb);
...
inline flatbuffers::Offset<DTUIFormData> CreateDTUIFormDataDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    uint32_t Id = 0,
  ...
  return GameConfig::CreateDTUIFormData(
      _fbb,
      Id,
      UIName__,
      UIGroupName__,
...
struct DTUIFormDataList FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_DATA = 4
  };
  const flatbuffers::Vector<flatbuffers::Offset<DTUIFormData>> *data() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<DTUIFormData>> *>(VT_DATA);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct DTUIFormDataListBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_data(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<DTUIFormData>>> data) {
    fbb_.AddOffset(DTUIFormDataList::VT_DATA, data);
  }
  explicit DTUIFormDataListBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  DTUIFormDataListBuilder &operator=(const DTUIFormDataListBuilder &);
  flatbuffers::Offset<DTUIFormDataList> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<DTUIFormDataList>(end);
    return o;
  }
};

inline flatbuffers::Offset<DTUIFormDataList> CreateDTUIFormDataList(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<DTUIFormData>>> data = 0) {
  DTUIFormDataListBuilder builder_(_fbb);
  builder_.add_data(data);
  return builder_.Finish();
}

inline flatbuffers::Offset<DTUIFormDataList> CreateDTUIFormDataListDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<DTUIFormData>> *data = nullptr) {
  auto data__ = data ? _fbb.CreateVector<flatbuffers::Offset<DTUIFormData>>(*data) : 0;
  return GameConfig::CreateDTUIFormDataList(
      _fbb,
      data__);
}
...
#endif  // FLATBUFFERS_GENERATED_DTUIFORMDATA_GAMECONFIG_H_
