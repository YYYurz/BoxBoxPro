...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp17(object p0, GameFramework.Event.GameEventArgs p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp18(int p0, byte[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new UnityEngine.Events.UnityAction<int>(__Gen_Delegate_Imp14);
			}
			...
			{
			    return new UnityEngine.Events.UnityAction<UnityEngine.Vector2>(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(System.EventHandler<GameFramework.Event.GameEventArgs>))
			{
			    return new System.EventHandler<GameFramework.Event.GameEventArgs>(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(System.Action<int, byte[]>))
			{
			    return new System.Action<int, byte[]>(__Gen_Delegate_Imp18);
			}
			...
			{
			    return new GameFramework.GameFrameworkAction<object>(__Gen_Delegate_Imp20);
			}
