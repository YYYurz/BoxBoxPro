...
public struct DTUIFormData : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static DTUIFormData GetRootAsDTUIFormData(ByteBuffer _bb) { return GetRootAsDTUIFormData(_bb, new DTUIFormData()); }
  public static DTUIFormData GetRootAsDTUIFormData(ByteBuffer _bb, DTUIFormData obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p.bb_pos = _i; __p.bb = _bb; }
  public DTUIFormData __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<DTUIFormData> CreateDTUIFormData(FlatBufferBuilder builder,
      uint Id = 0,
    ...
    DTUIFormData.AddLuaFile(builder, LuaFileOffset);
    DTUIFormData.AddAssetPath(builder, AssetPathOffset);
    DTUIFormData.AddPauseCoveredUIForm(builder, PauseCoveredUIForm);
    DTUIFormData.AddAllowMultiInstance(builder, AllowMultiInstance);
    DTUIFormData.AddUIGroupName(builder, UIGroupNameOffset);
    DTUIFormData.AddUIName(builder, UINameOffset);
    DTUIFormData.AddId(builder, Id);
    return DTUIFormData.EndDTUIFormData(builder);
  }

  public static void StartDTUIFormData(FlatBufferBuilder builder) { builder.StartObject(7); }
  ...
  public static Offset<DTUIFormData> EndDTUIFormData(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<DTUIFormData>(o);
  }
};

public struct DTUIFormDataList : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static DTUIFormDataList GetRootAsDTUIFormDataList(ByteBuffer _bb) { return GetRootAsDTUIFormDataList(_bb, new DTUIFormDataList()); }
  public static DTUIFormDataList GetRootAsDTUIFormDataList(ByteBuffer _bb, DTUIFormDataList obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p.bb_pos = _i; __p.bb = _bb; }
  public DTUIFormDataList __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }

  public DTUIFormData? Data(int j) { int o = __p.__offset(4); return o != 0 ? (DTUIFormData?)(new DTUIFormData()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int DataLength { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<DTUIFormDataList> CreateDTUIFormDataList(FlatBufferBuilder builder,
      VectorOffset dataOffset = default(VectorOffset)) {
    builder.StartObject(1);
    DTUIFormDataList.AddData(builder, dataOffset);
    return DTUIFormDataList.EndDTUIFormDataList(builder);
  }

  public static void StartDTUIFormDataList(FlatBufferBuilder builder) { builder.StartObject(1); }
  public static void AddData(FlatBufferBuilder builder, VectorOffset dataOffset) { builder.AddOffset(0, dataOffset.Value, 0); }
  public static VectorOffset CreateDataVector(FlatBufferBuilder builder, Offset<DTUIFormData>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateDataVectorBlock(FlatBufferBuilder builder, Offset<DTUIFormData>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static void StartDataVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<DTUIFormDataList> EndDTUIFormDataList(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<DTUIFormDataList>(o);
  }
};
